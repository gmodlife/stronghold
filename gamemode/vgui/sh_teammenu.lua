...
function PANEL:Init()
	...
	self.Sections:AddSheet( "Selected Team", self.JoinPanel, "gui/silkicons/application_view_detail" )
	
	self.CreatePanel = vgui.Create( "sh_teamcreatepanel", self.Sections )
	self.Sections:AddSheet( "Create team", self.CreatePanel, "gui/silkicons/application_put" )
	
	self.ManagePanel = vgui.Create( "sh_teammanagepanel", self.Sections )
	self.Sections:AddSheet( "Manage team", self.ManagePanel, "gui/silkicons/application_form_magnify" )
