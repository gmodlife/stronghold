...
function ENT:Initialize()
	...
	timer.Simple( 1,
			function( ent )
			self:EmitSound( "buttons/button17.wav", pos, 110, 110 )
		end, self )
	timer.Simple( 2,
			function( ent )
			self:EmitSound( "buttons/button17.wav", pos, 120, 120 )
		end, self )
	timer.Simple( 3,
			function( ent )
			self:EmitSound( "buttons/button17.wav", pos, 130, 130 )
		end, self )
	timer.Simple( 4,
			function( ent )
			self:EmitSound( "buttons/button17.wav", pos, 140, 140 )
		end, self )
	timer.Simple( 5,
			function( ent )
			self:EmitSound( "buttons/button17.wav", pos, 150, 150 )
		end, self )
end
