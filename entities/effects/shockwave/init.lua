...
function EFFECT:Think( )
	...
	self.Refract = self.Refract + 10.0 * FrameTime()
	self.Size = 512 * self.Refract^(0.05)
...
function EFFECT:Render()
	...
	matRefraction:SetMaterialFloat( "$refractamount", math.sin( self.Refract * math.pi ) * 0.01 )
