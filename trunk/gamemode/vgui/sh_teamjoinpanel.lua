...
function PANEL:Paint()
	...
	draw.RoundedBox( 4, w*0.125, 0, w*0.75, self:GetTall(), Color(50,50,50,180) )
	...
	if IsValid( self.Entity ) then
		...
		cam.Start3D( ang:Forward()*100, (ang:Forward()*-1):Angle(), self.fFOV, x, y, self:GetWide(), self:GetTall() )
